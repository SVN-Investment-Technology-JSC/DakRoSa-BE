...
export class AddWarehouseToWorkOrderMaterial1785205903785 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "work_order_materials" ADD "warehouse_id" uuid NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "work_order_materials" ADD CONSTRAINT "FK_e5e806f40b82cd528a68e6d07f5" FOREIGN KEY ("warehouse_id") REFERENCES "warehouses"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "work_order_materials" DROP CONSTRAINT "FK_e5e806f40b82cd528a68e6d07f5"`);
        ...
        await queryRunner.query(`ALTER TABLE "work_order_materials" DROP COLUMN "warehouse_id"`);
    }
