...
export class Phase2Entities1784881915125 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."work_orders_type_enum" AS ENUM('INCIDENT', 'MAINTENANCE')`);
        await queryRunner.query(`CREATE TYPE "public"."work_orders_status_enum" AS ENUM('DRAFT', 'ASSIGNED', 'IN_PROGRESS', 'COMPLETED', 'CLOSED')`);
        ...
        await queryRunner.query(`CREATE TABLE "work_order_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "work_order_id" uuid NOT NULL, "user_id" uuid NOT NULL, "action" character varying(100) NOT NULL, "note" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_f21127067c91a0b0882e060e616" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "work_order_materials" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "work_order_id" uuid NOT NULL, "material_id" uuid NOT NULL, "quantity" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_ef5cf27418c13b17bdf514e58f8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "equipments" ADD CONSTRAINT "FK_71de44396bcb488769c7df5cbe3" FOREIGN KEY ("parent_id") REFERENCES "equipments"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "equipment_documents" ADD CONSTRAINT "FK_c1154af788f437b09c3b1c240f8" FOREIGN KEY ("equipment_id") REFERENCES "equipments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "material_inventory" ADD CONSTRAINT "FK_d43eaf7ae8b14495c1e95ab5771" FOREIGN KEY ("warehouse_id") REFERENCES "warehouses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "material_inventory" ADD CONSTRAINT "FK_196b19790f38a237240adb52959" FOREIGN KEY ("material_id") REFERENCES "materials"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "inventory_transactions" ADD CONSTRAINT "FK_27111e3d0262799c28ca96e3368" FOREIGN KEY ("material_id") REFERENCES "materials"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inventory_transactions" ADD CONSTRAINT "FK_d9a2ac973b889087b33f84d3517" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "work_orders" ADD CONSTRAINT "FK_d32006339c17274522170264915" FOREIGN KEY ("equipment_id") REFERENCES "equipments"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "work_orders" ADD CONSTRAINT "FK_9c1631b04d686bd0cdaca9e0e25" FOREIGN KEY ("reporter_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "work_orders" ADD CONSTRAINT "FK_05b6760717afdaf9d47729378aa" FOREIGN KEY ("assignee_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "work_order_logs" ADD CONSTRAINT "FK_83f0bab24ae0c51ceff71783d0d" FOREIGN KEY ("work_order_id") REFERENCES "work_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "work_order_logs" ADD CONSTRAINT "FK_b46d0e0bb80f23ea700e91fd859" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "work_order_materials" ADD CONSTRAINT "FK_259c6f46d9485959a5912a4b678" FOREIGN KEY ("work_order_id") REFERENCES "work_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "work_order_materials" ADD CONSTRAINT "FK_062155b1581f3519437d4dc2eb2" FOREIGN KEY ("material_id") REFERENCES "materials"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "maintenance_plans" ADD CONSTRAINT "FK_38f013990c92480e7b45b520054" FOREIGN KEY ("equipment_id") REFERENCES "equipments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "maintenance_plans" DROP CONSTRAINT "FK_38f013990c92480e7b45b520054"`);
        await queryRunner.query(`ALTER TABLE "work_order_materials" DROP CONSTRAINT "FK_062155b1581f3519437d4dc2eb2"`);
        await queryRunner.query(`ALTER TABLE "work_order_materials" DROP CONSTRAINT "FK_259c6f46d9485959a5912a4b678"`);
        await queryRunner.query(`ALTER TABLE "work_order_logs" DROP CONSTRAINT "FK_b46d0e0bb80f23ea700e91fd859"`);
        await queryRunner.query(`ALTER TABLE "work_order_logs" DROP CONSTRAINT "FK_83f0bab24ae0c51ceff71783d0d"`);
        await queryRunner.query(`ALTER TABLE "work_orders" DROP CONSTRAINT "FK_05b6760717afdaf9d47729378aa"`);
        await queryRunner.query(`ALTER TABLE "work_orders" DROP CONSTRAINT "FK_9c1631b04d686bd0cdaca9e0e25"`);
        await queryRunner.query(`ALTER TABLE "work_orders" DROP CONSTRAINT "FK_d32006339c17274522170264915"`);
        await queryRunner.query(`ALTER TABLE "inventory_transactions" DROP CONSTRAINT "FK_d9a2ac973b889087b33f84d3517"`);
        await queryRunner.query(`ALTER TABLE "inventory_transactions" DROP CONSTRAINT "FK_27111e3d0262799c28ca96e3368"`);
        ...
        await queryRunner.query(`ALTER TABLE "equipment_documents" DROP CONSTRAINT "FK_c1154af788f437b09c3b1c240f8"`);
        await queryRunner.query(`ALTER TABLE "equipments" DROP CONSTRAINT "FK_71de44396bcb488769c7df5cbe3"`);
