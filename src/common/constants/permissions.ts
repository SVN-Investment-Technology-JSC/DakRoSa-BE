...
export const PERMISSION_CATALOG: ReadonlyArray<{
  ...
  {
    key: PERMISSIONS.WORKFLOW_DEFINITION_VIEW,
    name: 'Xem mẫu quy trình',
    group: 'Bảo trì',
    description: 'Xem quy trình, sơ đồ và lịch sử phiên bản của doanh nghiệp.',
  },
  {
    key: PERMISSIONS.WORKFLOW_DEFINITION_MANAGE,
    name: 'Thiết kế quy trình',
    group: 'Bảo trì',
    description: 'Tạo, chỉnh sửa, nhân bản và kiểm tra quy trình nháp.',
  },
  {
    key: PERMISSIONS.WORKFLOW_DEFINITION_PUBLISH,
    name: 'Công bố quy trình',
    group: 'Bảo trì',
    description: 'Công bố phiên bản quy trình để áp dụng cho công việc mới.',
  },
  {
    key: PERMISSIONS.MAINTENANCE_JOB_PLAN_VIEW,
    name: 'Xem mẫu công việc',
    group: 'Bảo trì',
    description: 'Xem hướng dẫn, checklist và tiêu chí kỹ thuật.',
  },
  {
    key: PERMISSIONS.MAINTENANCE_JOB_PLAN_MANAGE,
    name: 'Quản lý mẫu công việc',
    group: 'Bảo trì',
    description: 'Tạo và cập nhật phiên bản nháp của mẫu công việc.',
  },
  {
    key: PERMISSIONS.MAINTENANCE_JOB_PLAN_PUBLISH,
    name: 'Công bố mẫu công việc',
    group: 'Bảo trì',
    description: 'Khóa và công bố mẫu công việc để dùng trong lịch bảo trì.',
  },
  {
    key: PERMISSIONS.MAINTENANCE_SCHEDULE_VIEW,
    name: 'Xem lịch bảo trì',
    group: 'Bảo trì',
    description: 'Xem kế hoạch, occurrence và lịch theo thời gian.',
  },
  {
    key: PERMISSIONS.MAINTENANCE_SCHEDULE_MANAGE,
    name: 'Quản lý lịch bảo trì',
    group: 'Bảo trì',
    description: 'Tạo lịch, cấu hình trigger, kích hoạt và tạm dừng lịch.',
  },
  {
    key: PERMISSIONS.MAINTENANCE_METER_READ,
    name: 'Ghi chỉ số thiết bị',
    group: 'Bảo trì',
    description: 'Nhập chỉ số giờ chạy, số chu kỳ hoặc phép đo thiết bị.',
  },
  {
    key: PERMISSIONS.WORK_ORDER_EXECUTE,
    name: 'Thực hiện công việc',
    group: 'Bảo trì',
    description: 'Tiếp nhận, cập nhật tiến độ và gửi kết quả bảo trì.',
  },
  {
    key: PERMISSIONS.WORK_ORDER_REVIEW,
    name: 'Kiểm tra kỹ thuật',
    group: 'Bảo trì',
    description: 'Nghiệm thu, xác nhận hoặc yêu cầu thực hiện lại.',
  },
  {
    key: PERMISSIONS.NOTIFICATIONS_VIEW,
    name: 'Xem thông báo',
    group: 'Công việc',
    description: 'Xem và đánh dấu thông báo trong ứng dụng.',
  },
];
